...
<body>
    ...
    switch (date("m",strtotime(substr($nowtime,0,2)."/".substr($nowtime,2,2)."/".substr($nowtime,4,4))))
    {
    ...
    <h2 style="margin-top: 15px;margin-left: 210px;font-size: 50px;">เมื่อประจำวันที่ <?php echo date("j",strtotime(substr($nowtime,0,2)."/".substr($nowtime,2,2)."/".substr($nowtime,4,4))); ?> <?php echo $monthtext; ?> <?php echo date("Y",strtotime(substr($nowtime,0,2)."/".substr($nowtime,2,2)."/".substr($nowtime,4,4)))+543; ?></h2>
