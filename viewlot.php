...
<body>
    ...
    <? if(count($obj[2]) == 5) { ?>
        <h2 style="margin-top: 25px;margin-left: 325px;font-size: 60px;">เลขท้าย สามตัว</h2>
        <h2 style="font-size: 100px;margin-left: 260px;"><?php echo $obj[2][1]; ?> | <?php echo $obj[2][2]; ?></h2>
        <h2 style="font-size: 5.96vw;margin-left: 805px;max-width: 475px;"><?php echo $obj[2][3]; ?> | <?php echo $obj[2][4]; ?></h2>
    <? } else { ?>
